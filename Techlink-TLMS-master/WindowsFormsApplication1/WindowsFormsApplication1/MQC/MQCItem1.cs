...
namespace WindowsFormsApplication1.MQC
{
   public class MQCItem1
    ...
    public class TargetMQC
    {
     ...
     public   Dictionary<string, double> TargetInTimeDayShift = new Dictionary<string, double>();
        public Dictionary<string, double> TargetInTimeNightShift = new Dictionary<string, double>();
    }
