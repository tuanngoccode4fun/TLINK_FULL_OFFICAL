...
namespace WindowsFormsApplication1.Database
{
 public   class COPTH
    {
        public static DataTable GetdtTop1COPTH()
        {
            DataTable dt = new DataTable();
            string querry = " select top(1) * from COPTH ";
...

		{
			try
			{
				...
				stringBuilder.Append(" insert into COPTH ( ");
			...
			catch (Exception ex)
			{
				...
				SystemLog.Output(SystemLog.MSG_TYPE.Err, "COPTH", ex.Message);
			}
			return false;
		}
