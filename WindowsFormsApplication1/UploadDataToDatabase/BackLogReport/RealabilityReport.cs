 ...
 public   class RealabilityReport
    {
        ...
        public bool SendMailReliabilityReportAdding7Days(string pathSave)
        {
            ...
            try
            {
                ...
                ListReliability = realabilityReport.GetDataForReliability(dateFrom, dateTo, rawReliabilities, out ListReliabilityDept, out ListReliabilityClient7Days, out ListReliabilityDept7Days);
                ExportExcelTool exportExcelTool = new ExportExcelTool();
                string path = pathSave+ @"\Reliability_Report_W" + WeekNo.ToString() + "_" + DateTime.Now.ToString("ddMMMyyyy") + ".xlsx";
                exportExcelTool.ExportToReliabilityReportAdding7DaysAddingRawData(pathTemplate, path, ListReliability, ListReliabilityDept, ListReliabilityClient7Days, ListReliabilityDept7Days, rawReliabilities, dateFrom, dateTo);
            }
        ...
        public bool SendMailReliabilityReporAdding7DaystMonthly(string patchSave)
        {
            try
            {
                DateTimeFormatInfo dfi = DateTimeFormatInfo.CurrentInfo;
                ...
                ListReliability = realabilityReport.GetDataForReliability(dateFrom, dateTo, rawReliabilities ,out ListReliabilityDept, out ListReliabilityClient7Days, out ListReliabilityDept7Days);
                ExportExcelTool exportExcelTool = new ExportExcelTool();
                string path = patchSave + @"\Reliability_Report"  + "_" + dateTo.ToString("MMMyyyy") + ".xlsx";
                exportExcelTool.ExportToReliabilityReportAdding7DaysAddingRawData(pathTemplate, path, ListReliability, ListReliabilityDept, ListReliabilityClient7Days, ListReliabilityDept7Days, rawReliabilities, dateFrom, dateTo);
            }
